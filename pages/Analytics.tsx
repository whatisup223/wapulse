  ...
  return (
    <div className="p-6 space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white">{isRtl ? 'التقارير والتحليلات' : 'Reports & Analytics'}</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border dark:border-slate-800 shadow-sm">
          <h3 className="font-bold text-slate-900 mb-8 dark:text-white">{isRtl ? 'حالة تسليم الرسائل' : 'Message Delivery Status'}</h3>
          <div className="h-64">
        ...
        <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border dark:border-slate-800 shadow-sm">
          <h3 className="font-bold text-slate-900 mb-8 dark:text-white">{isRtl ? 'التفاعل بالساعة' : 'Engagement by Hour'}</h3>
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
      ...
      <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border dark:border-slate-800 shadow-sm overflow-hidden">
        <h3 className="font-bold text-slate-900 mb-6 dark:text-white">{isRtl ? 'إحصائيات التفاعل الرئيسية' : 'Key Performance Metrics'}</h3>
          ...
          {[
            ...
            <div key={i} className="text-center md:text-left">
              ...
              <div className="flex items-baseline justify-center md:justify-start gap-2">
                <span className="text-2xl font-bold text-slate-900 dark:text-white">{metric.val}</span>
